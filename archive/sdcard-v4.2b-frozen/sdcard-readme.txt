...
. Changed X1 pad to allow use of cheaper barrel style xtal 
  parts to be used. (Too many changes required for same 
  quick change on UK version, for now anyway sorry.)
...
. Main 8-way connectors were in back to front on both variants of the board (Std and UK)
  Now corrected.  
